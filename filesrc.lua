...
spawn(function() 
    ...
    wait(.29)
    require(game.ReplicatedStorage.Notification).new("<Color=Yellow> Sub youtube pringleseater để xem video mới nhất nhé<Color=/>"):Display()
    wait(.36)
end)
...
W:AddLabel("SHNAHK")
W:AddLabel("SKIBIDI SCRIPT")
W:AddLabel("https://discord.gg/KuDTr7gD")
local Section = W:AddSection({
    Name = "Status"
})
